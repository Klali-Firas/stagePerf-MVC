...
require_once "../model/Article/CRUDArticle.php";

class CRUDVente
{
    private $CRUD_Article;
    private $pdo;
    function __construct()
    {
        $this->CRUD_Article = new CRUDArticle();
        $obj = new connexion();
    ...
    function modifierVente(Vente $vente)
    {
        ...
        header('Location: vente.php?id=' . $vente->getId());
        exit;
    }
