    ...
    <div class="overview-boxes">
        <div class="box">
            <form action="<?= !empty($_GET['id']) ? "../model/modifClient.php" : "../model/ajoutClient.php" ?>" method="post">
                ...
                <input value="<?= !empty($_GET['id']) ? $client['telephone'] : "" ?>" type="text" name="telephone" id="telephone" placeholder="Veuillez saisir le Numéro de Téléphone">
                    ...
                    foreach ($clients as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="?id=<?= $value['id'] ?>"><i class='bx bx-edit-alt'></i></a>
                                <a href="../model/suppClient.php?id=<?= $value['id'] ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce client?')"><i class='bx bx-trash'></i></a>
                            </td>
                        </tr>
                <?php
                    }
