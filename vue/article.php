        ...
        <div class="box">
            <form method="post">
                ...
                <input value="<?= !empty($_GET['id']) ? $article['nom_article'] : "" ?>" type="text" name="nom_article"
                    id="nom_article" placeholder="Veuillez saisir le nom">
                ...
                <input value="<?= !empty($_GET['id']) ? $article['quantite'] : "" ?>" type="number" name="quantite"
                    id="quantite" placeholder="Veuillez saisir la quantité">

                <label for="prix_unitaire">Prix unitaire</label>
                <input value="<?= !empty($_GET['id']) ? $article['prix_unitaire'] : "" ?>" type="number"
                    name="prix_unitaire" id="prix_unitaire" placeholder="Veuillez saisir le prix">
                ...
                if (!empty($articles) && is_array($articles)) {
                    foreach ($articles as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="?id=<?= $value['id'] ?>&delete=true"
                                    onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet article?')"><i
